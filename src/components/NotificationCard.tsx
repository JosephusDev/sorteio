...
import { AccountNotificationIcon, ErrorNotificationIcon, SuccessNotificationIcon } from "@/assets/icons";
    ...
    return(
        <View className="w-full bg-white overflow-hidden shadow-xl mb-1">
            <View className="p-4 flex-row justify-center items-center gap-4">
                ...
                <View className="w-[60%]">
                    <Text className="text-greyscale-900 text-base font-urbanist-bold mb-1" numberOfLines={2}>
