  ...
  return (
    <Fragment>
      <Tabs screenOptions={{ 
        ...
        tabBarLabelStyle: { fontFamily: "Urbanist_600SemiBold", fontSize: 13 } 
      }}>
        <Tabs.Screen name="home" options={{ title: "Início", tabBarIcon: ({ color, focused }) => (
          <HomeIcon color={color} fill={focused ? color : "none"} />
        ) }} />
        <Tabs.Screen name="bet" options={{ title: "Apostas", tabBarIcon: ({ color, focused }) => (
          <MoneyIcon color={color} fill={focused ? color : "none"} />
        ) }} />
        <Tabs.Screen name="card" options={{ title: "Transações", tabBarIcon: ({ color, focused }) => (
